    ...
    <div class="justify-center w-full mx-auto">
        <div class="flex flex-col w-full px-8 py-2 mx-auto md:px-12 md:items-center md:justify-between md:flex-row lg:px-32 max-w-7xl">
            <div class="flex flex-row items-center justify-between text-black">
                <a class="inline-flex items-center gap-3 text-lg font-bold tracking-tight text-indigo-800" href="/">
            ...
            <div class="flex-col items-center text-xs gap-12  font-medium text-indigo-800 md:flex md:flex-row lg:p-0 md:mt-0">
                ...
                <a class="hover:text-blue-600 focus:outline-none focus:text-gray-500 md:ml-auto" href="#_">Produk</a>
                <a class="hover:text-blue-600 focus:outline-none focus:text-gray-500 md:ml-auto" href="{{route('register')}}">Register</a>
                <a href="{{route('login')}}">
                    <button type="button" class="rounded-md bg-indigo-800 px-6 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                        Masuk
                    </button>
                </a>
            </div>
