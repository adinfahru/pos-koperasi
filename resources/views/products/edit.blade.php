        ...
        <form method="POST" action="{{ route('products.update', $product->id)}}" enctype="multipart/form-data">
            ...
            <div class="w-full border-gray-900/10 pb-12 flex flex-col gap-4">
                ...
                <div class="flex gap-2 items-center">
                    <div class="">
                        <img aria-hidden="true" class="w-[32px] h-[32px]"
                            src="{{ asset('images/package.png') }}" alt="" />
                    </div>
                ...
                <div class="w-full flex flex-col gap-5">
                    ...
                    <div class="flex gap-2 justify-between">
                        ...
                        <div class="w-3/4 self-center">
                            ...
                            <div class="mt-2">
                                <input for="image" name="image" id="image" type="file" value="{{ $product->image }}" class="block w-full text-sm text-gray-900 py-2 px-5 border-0 ring-1 ring-inset ring-gray-300  border-gray-300 rounded-lg cursor-pointer bg-gray-100 dark:text-gray-400 focus:outline-none">
                            </div>
                        </div>
                    </div>
                </div>
                
                <div class="mt-5 flex items-centerg gap-3 justify-between">
                    <div class="w-1/2">
                        <a href="{{ route('products.index') }}"><button type="button" class="block w-full text-sm px-12 py-2 rounded-md font-bold bg-white border border-gray-200 shadow-xl hover:bg-red-500 leading-6 text-gray-900">Cancel</button></a>
                    </div>
