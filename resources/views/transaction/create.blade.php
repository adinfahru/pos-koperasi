            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <div class="md:w-2/4">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 border text-xs">
                        ...
                        <a href="" class="rounded-md bg-indigo-600 p-1 text-sm text-xs font-semibold text-white shadow-sm hover:bg-indigo-500">Selesai</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-2">
                                    <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        <input type="number" name="total_belanja" id="" class="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                            </div>
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-2">
                                    <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        <input type="number" name="dibayarkan" id="" class="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-2">
                                    <div class="flex rounded-md bg-gray-200 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        <input type="number" disabled name="kembalian" class="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                            </div>
                        </div>
