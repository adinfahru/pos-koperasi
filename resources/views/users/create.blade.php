                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-4">
                        ...
                        <label for="role" class="block text-sm leading-6 text-gray-900">Role</label>
                            <select id="role" name="role" class="capitalize block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                                <option>user</option>
                                <option>admin</option>
